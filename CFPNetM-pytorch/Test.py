...
parser.add_argument('--pth_path', type=str, default='./snapshots/....')



for _data_name in ['IRS']:
    ##### put ur data_path here #####
    data_path = 'D:/CFPNetM/TestDataset/{}/'.format(_data_name)
    #####                       #####
    
    save_path = './results/CFPNetM/{}/'.format(_data_name)
