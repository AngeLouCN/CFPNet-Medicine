...
def train(train_loader, model, optimizer, epoch, test_path):
    ...
    for i, pack in enumerate(train_loader, start=1):
        for rate in size_rates:
            ...
            loss = structure_loss(lateral_map_1, gts)
            ...
            if rate == 1:
                ...
                loss_record1.update(loss.data, opt.batchsize)
        # ---- train visualization ----
    ...
    if (epoch+1) % 1 == 0:
        ...
        if meandice > float(best):
            ...
            best = fp.read()
            fp.close()
            torch.save(model.state_dict(), save_path + 'CFPNETM-best.pth' )
            print('[Saving Snapshot:]', save_path + 'CFPNETM-best.pth',meandice,'[best:]',best)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_path', type=str,
                        default='./TestDataset/' , help='path to testing Kvasir dataset')
    
    parser.add_argument('--train_save', type=str,
                        default='CFPNETM-best')
