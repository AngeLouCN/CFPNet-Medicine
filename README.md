...
This repository contains the implementation of a novel light-weight real-time network (CFPNet-Medicine: CFPNet-M) to segment different types of biomedical images. It is a medical version of CFPNet, and the dataset we used from top to bottom are DRIVE, ISBI-2012, Infrared Breast, CVC-ClinicDB and ISIC 2018. The details of [CFPNet-M](https://arxiv.org/ftp/arxiv/papers/2105/2105.04075.pdf) and CFPNet [Paper](https://arxiv.org/ftp/arxiv/papers/2103/2103.12212.pdf) can be found here respectively.  
