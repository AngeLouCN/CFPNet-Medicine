...
This repository contains the implementation of a novel light-weight real-time network (CFPNet-Medicine: CFPNet-M) to segment different types of biomedical images. It is a medical version of CFPNet [Code][1]  (https://github.com/AngeLouCN/CFPNet) [paper](https://arxiv.org/abs/2103.12212), and the dataset we used from top to bottom are DRIVE, ISBI-2012, Infrared Breast, CVC-ClinicDB and ISIC 2018.
[1]: https://github.com/AngeLouCN/CFPNet
