...
This repository contains the implementation of a novel light-weight real-time network (CFPNet-Medicine: CFPNet-M) to segment different types of biomedical images. It is a medical version of CFPNet 
[code](https://github.com/AngeLouCN/CFPNet) 
[paper](https://arxiv.org/abs/2103.12212)
